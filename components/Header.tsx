...
import { 
    ...
    PaperAirplaneIcon, 
    PhoneIcon, 
    PlayCircleIcon } from "@heroicons/react/20/solid";
                    ...
                    rounded-3xl shadow-lg ring-1 ring-gray-900/5">
                        ...
                        <div className="p-4">
                            {products.map((item) => (
                                ...
                                <item.icon
                                className="h-6 w-6 text-[#13B94] group-hover:text-blue-600"
                                aria-hidden="true"
                                />
                                </div>
                        ...
                        <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                            {callsToAction.map((item) => (
                                ...
                                key={item.name}
                                href={item.href}
                                className="flex items-center justify-center gap-x-2.5 p-3 text-sm font-semibold leading-6 text-
                                [#013B94] hover:bg-gray-100"
                                >
                                  <item.icon
